...
class _CustomCheckboxRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  @override
  _RenderCustomCheckbox createRenderObject(BuildContext context) => _RenderCustomCheckbox(
    value: value,
    tristate: tristate,
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderCustomCheckbox renderObject) {
    renderObject
      ..value = value
      ..tristate = tristate
      ..activeColor = activeColor
